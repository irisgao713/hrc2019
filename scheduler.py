...
def mkdir():
    os.chdir('../results') 
    fold1 = "raw_html/apa/" +this_month() +"test"
    fold2 = "raw_html/roo/" +this_month() + "test"
...
if __name__ == '__main__':
    ...
    scheduler.add_job(check_rows,'cron',args=["listings-" + last_month() + ".csv"], day = '3', hour=9, minute=rand_min())
